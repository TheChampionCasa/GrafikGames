    ...
    <div class="container mt-3">
            ...
            <div class="col col-lg-2 text-center">
                          <?php
                            ...
                            if(isset($_GET["cookiedestroy"])){
                                ...
                                header("Location:Need_For_Speed_Unbound.php");
                            }
                          ?>
        ...
        <div id="alerts" style="color: white;"></div>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../imgs/nfs/1.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/2.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/3.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/4.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/5.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/6.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/nfs/7.jpg" class="d-flex w-100">
                      </div>
                    </div>
            ...
            <div class="col-4 mt-5"><!--INFO Producto-->
                <img class="rounded-2 w-100 mx-auto d-block" src="../imgs/nfscard.jpg" alt="">
                <h2 class="productname">Need for Speed™ Unbound</h2>
                <p class="mt-5">Corre hasta lo más alto, sin llevarte chascos. Supera a la policía y participa en las eliminatorias semanales del Grand, la carrera callejera definitiva. Llena tu garaje de coches personalizados y tuneados con precisión e inunda las calles con tu estilo.</p>
                <p class="price">70€
            ...
            <div class="col-12 mt-5"><!--Descripcion-->
                ...
                <p class="col-10">El mundo es tu lienzo en Need for Speed™ Unbound. Demuestra que tienes lo que hay que tener para ganar el Grand, el desafío de carreras callejeras definitivo de Lakeshore. A lo largo de 4 semanas de carreras intensas, gana el dinero suficiente para participar en las eliminatorias semanales, supera a tus rivales y deja huella en el mundillo de las carreras callejeras mientras le das un repaso a la policía. Llena tu garaje de coches personalizados y tuneados con precisión e inunda las calles con tu estilo único, atuendos exclusivos y una potente banda sonora mundial que resonará en todas partes gracias a A$AP Rocky y AWGE. Exprésate al máximo con las últimas corrientes artísticas y los grafitis característicos que muestran de qué rollo vas. Con campañas individuales y multijugador separadas, esta última edición de la franquicia de Need for Speed de Criterion Games™ ofrece horas y horas de acción llenas de adrenalina.</p>
