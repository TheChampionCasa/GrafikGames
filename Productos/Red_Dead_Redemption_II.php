    ...
    <div class="container mt-3">
            ...
            <div class="col col-lg-2 text-center">
                          <?php
                            ...
                            if(isset($_GET["cookiedestroy"])){
                                ...
                                header("Location:Red_Dead_Redemption_II.php");
                            }
                          ?>
        ...
        <div id="alerts" style="color: white;"></div>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../imgs/rdr2/1.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/rdr2/2.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/rdr2/3.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/rdr2/4.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/rdr2/5.jpg" class="d-flex w-100">
                      </div>
                    </div>
            ...
            <div class="col-4 mt-5"><!--INFO Producto-->
                <img class="rounded-2 w-100 mx-auto d-block" src="../imgs/rdr2.jpg" alt="">
                <h2 class="productname">Red Dead Redemption II</h2>
                <p class="mt-5">Con más de 175 premios al Juego del año y más de 250 valoraciones perfectas, Red Dead Redemption 2 es la épica historia de Arthur Morgan y la banda de Van der Linde, que huyen por toda América en el albor de una nueva era. También incluye acceso al mundo multijugador compartido de Red Dead Online.</p>
                <p class="price">20€
