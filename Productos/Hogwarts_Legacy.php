    ...
    <div class="container mt-3">
            ...
            <div class="col col-lg-2 text-center">
                          <?php
                            ...
                            if(isset($_GET["cookiedestroy"])){
                                ...
                                header("Location:Hogwarts_Legacy.php");
                            }
                          ?>
        ...
        <div id="alerts" style="color: white;"></div>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../imgs/hp/1.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/hp/2.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/hp/3.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/hp/4.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/hp/5.jpg" class="d-flex w-100">
                      </div>
                    </div>
            ...
            <div class="col-4 mt-5"><!--INFO Producto-->
                <img class="rounded-2 w-100 mx-auto d-block" src="../imgs/hpcard.jpg" alt="">
                <h2 class="productname">Hogwarts Legacy</h2>
                <p class="mt-5">Hogwarts Legacy es un RPG inmersivo de acción en mundo abierto.
                   Ahora puedes tomar el control de la acción y ser el centro de tu propia aventura en el mundo mágico.</p>
                <p class="price">60€
            ...
            <div class="col-12 mt-5"><!--Descripcion-->
                ...
                <p class="col-10">Hogwarts Legacy es un RPG de acción en un mundo abierto ambientado en el universo de los libros de Harry Potter.
                   Embárcate en un viaje que te llevará a lugares nuevos y ya conocidos, y en el que podrás descubrir animales fantásticos, personalizar
                   a tu personaje, elaborar pociones, dominar hechizos, mejorar tus habilidades y convertirte en la bruja o el mago que quieras ser.
                  Disfruta de Hogwarts en el siglo XIX. Tu personaje es un estudiante que tiene la clave de un antiguo secreto que amenaza la estabilidad del mundo mágico.
                   Consigue aliados, enfréntate a magos tenebrosos y decide el destino del mundo mágico. Tú defines tu legado. Escribe tu propia historia.</p>
