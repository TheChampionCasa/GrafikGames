    ...
    <div class="container mt-3">
            ...
            <div class="col col-lg-2 text-center">
                          <?php
                            ...
                            if(isset($_GET["cookiedestroy"])){
                                ...
                                header("Location:Wanted_Dead.php");
                            }
                          ?>
        ...
        <div id="alerts" style="color: white;"></div>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../imgs/wd/1.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/2.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/3.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/4.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/5.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/6.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/wd/7.jpg" class="d-flex w-100">
                      </div>
                    </div>
            ...
            <div class="col-4 mt-5"><!--INFO Producto-->
                <img class="rounded-2 w-100 mx-auto d-block" src="../imgs/wdcard.jpg" alt="">
                <h2 class="productname">Wanted Dead</h2>
                <p class="mt-5">Wanted: Dead es un nuevo híbrido slasher/shooter de los creadores de Ninja Gaiden y Dead or Alive. El juego sigue una semana en la vida de la Unidad Zombie, un escuadrón de policía de élite de Hong Kong en una misión para descubrir una gran conspiración corporativa.</p>
                <p class="price">60€
            ...
            <div class="col-12 mt-5"><!--Descripcion-->
                ...
                <p class="col-10">
                  Se busca: Dead es un nuevo híbrido slasher/shooter de los creadores de Ninja Gaiden y Dead or Alive. El juego sigue una semana en la vida de la Unidad Zombie, un escuadrón de élite de la policía de Hong Kong con la misión de descubrir una importante conspiración corporativa. Ponte en la piel de la teniente Hannah Stone, una policía de Hong Kong de perfil duro, y atraviesa mercenarios, pandilleros y contratistas militares privados en una espectacular aventura ciberpunk.
                  ...
                  Brutales remates: más de 50 movimientos finales únicos
                  Ciberpunk: una loca mezcla de armamento avanzado y futurismo retro de los 90
                  Una historia apasionante: La unidad Zombie descubre una gran conspiración corporativa en una versión distópica de Hong Kong
                  Experiencia realmente dura: los combates no van a ser fáciles, endurece tu determinación y utiliza todo lo que te rodea mientras luchas contra hordas de mercenarios, sintéticos y fuerzas de seguridad privadas.
                  Golpéalos al estilo de la vieja escuela: Derriba a los enemigos para avanzar, revive la nostalgia en un giro moderno del género establecido
                  Una carta de amor a la sexta generación de consolas.
                </p>
