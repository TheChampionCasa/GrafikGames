    ...
    <div class="container mt-3">
            ...
            <div class="col col-lg-2 text-center">
                          <?php
                            ...
                            if(isset($_GET["cookiedestroy"])){
                                ...
                                header("Location:Atomic_Heart.php");
                            }
                          ?>
        ...
        <div id="alerts" style="color: white;"></div>
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../imgs/ah/1.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/2.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/3.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/4.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/5.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/6.jpg" class="d-flex w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="../imgs/ah/7.jpg" class="d-flex w-100">
                      </div>
                    </div>
            ...
            <div class="col-4 mt-5"><!--INFO Producto-->
                <img class="rounded-2 w-100 mx-auto d-block" src="../imgs/ahcard.jpg" alt="">
                <h2 class="productname">Atomic Heart</h2>
                <p class="mt-5">Ten encuentros explosivos en un delirante y sublime mundo utópico. Adapta tu estilo de combate a cada rival, aprovecha el entorno y mejora el equipamiento para cumplir la misión. El precio de averiguar la verdad tendrás que pagarlo con sangre.</p>
                <p class="price">60€
            ...
            <div class="col-12 mt-5"><!--Descripcion-->
                ...
                <p class="col-10">
                    Te damos la bienvenida a un mundo utópico, maravilloso y perfecto, en el que los humanos viven en armonía con leales y complacientes robots.<br>
                    Bueno, al menos, hasta ahora. Apenas quedan unos días para el lanzamiento del más moderno sistema de control de robots y solo un trágico accidente
                    o una conspiración mundial podrían impedirlo...<br><br>
                    El imparable avance de la tecnología y el desarrollo de experimentos secretos han dado lugar a criaturas mutantes, máquinas aterradoras y robots 
                    superpoderosos que, de repente, se han rebelado contra sus creadores. Solo tú puedes detenerlos y averiguar qué hay más allá de este mundo ideal.<br><br>
                    Emplea las habilidades de combate que te otorgan tu guante eléctrico experimental y tu arsenal de armas de filo y de fuego avanzadas para luchar a 
                    vida o muerte en encuentros explosivos y frenéticos. Adapta tu estilo de combate a cada rival, combina habilidades y recursos, aprovecha el entorno
                     y mejora el equipamiento para superar retos y luchar por el bien.<br><br>
                     <ul>
                      <li>Un mundo utópico, tan delirante como sublime</li>
                      <li>Combates viscerales, espectaculares y despiadados</li>
                      <li>Revienta mutantes y máquinas gigantes con diversas habilidades y armas de tecnología punta</li>
                      <li>Mejora tu arsenal y equipamiento</li>
                     </ul>
                </p>
